...
PRINT 'Loaded acs2011 5 year raw pums datasets...'
...
SELECT [PUMA]
    ...
    ,[DIVISION]
	,[NP]
	,CASE	WHEN [ADJINC]=1102938 THEN CAST((([HINCP]/1.0)*1.016787*1.08473) AS decimal(9,2))
			WHEN [ADJINC]=1063801 THEN CAST((([HINCP]/1.0)*1.018389*1.04459) AS decimal(9,2))
			WHEN [ADJINC]=1048026 THEN CAST((([HINCP]/1.0)*0.999480*1.04857) AS decimal(9,2))
			WHEN [ADJINC]=1039407 THEN CAST((([HINCP]/1.0)*1.007624*1.03154) AS decimal(9,2))
			WHEN [ADJINC]=1018237 THEN CAST((([HINCP]/1.0)*1.018237*1.00000) AS decimal(9,2))
			ELSE 999
			END AS [hhincAdj] -- adjusted to 2011 dollars
	,[TEN]
	,[BLD]
...
PRINT 'Census acs2011 5 year input household data inserted into [hhtable]'
...
PRINT 'Census acs2011 5 year input person data inserted into [perstable]'
...
PRINT 'Census acs2011 5 year input group quarter household data inserted into [hhtable]'
...
PRINT 'Census acs2011 5 year input group quarter person data inserted into [perstable]'
GO
